...
- [ ] Implement your own bar chart with the same MoMA dataset you used in the section 2 version of this tutorial in our new boilerplate template. You can expand this to include all count of nationalities as well, or some other bar chart with the MoMA data. 
